...
const Testimonials = () => {
    return(
        ...
        className='container mx-auto py-10 md:px-20 lg:px-32 w-full overflow-hidden' id='Testimonials'>
            <h1 className='text-xl sm:text-4xl font-bold mb-2 text-center'>Customer <span className='underline underline-offset-4 decoration-1 under font-light'>Testimonials</span></h1>
            ...
            <div className='flex flex-wrap justify-center gap-8'>
                {testimonialsData.map((testimonial, index) => (
                   <div key={index} className='max-w-[340px] border shadow-lg rounded px-8 py-12 py-12 text-center'>
